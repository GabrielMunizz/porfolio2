...
export default function NavBar() {
  ...
  return (
    <nav className="flex fixed justify-center items-center w-[90%] border-2 border-white mt-4 min-h-10 rounded-lg bg-black z-50 md:min-h-20 lg:w-4/5 xl:w-3/5 2xl:w-1/3">
