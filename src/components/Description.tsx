export default function Description() {
  return (
    <div className="flex flex-col justify-start w-full h-full mb-[2rem] px-4 md:px-0 z-10">
      <div className="flex flex-col justify-start items-start h-[30%] w-full lg:h-[38%]">
        <h1 className="bebas text-[4rem] md:text-[8rem] font-bold mb-[-3rem] md:mb-[-5.8rem]">
          Gabriel
        </h1>
        <h1 className="bebas text-[4rem] md:text-[8rem] text-purple-600 font-bold mb-[-2rem] md:mb-[-3rem]">
          Muniz
        </h1>
      ...
      <p className="bebas text-[1.5rem] leading-9 hidden">
